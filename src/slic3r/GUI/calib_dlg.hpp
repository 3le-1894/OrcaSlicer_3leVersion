...
class FanSpeed_Test_Dlg : public DPIDialog
{
public:
    FanSpeed_Test_Dlg(wxWindow* parent, wxWindowID id, Plater* plater);
    ~FanSpeed_Test_Dlg();
    void on_dpi_changed(const wxRect& suggested_rect) override;
...
{
public:
    BridgeSpeed_Test_Dlg(wxWindow* parent, wxWindowID id, Plater* plater);
...
{
public:
    BridgeCooling_Test_Dlg(wxWindow* parent, wxWindowID id, Plater* plater);
