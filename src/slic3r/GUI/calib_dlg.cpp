...
FanSpeed_Test_Dlg::FanSpeed_Test_Dlg(wxWindow* parent, wxWindowID id, Plater* plater)
    : DPIDialog(parent, id, _L("Fan Speed Test"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE)
    , m_plater(plater)
{
    ...
    wxString start_str = _L("Min fan speed: ");
    wxString end_str   = _L("Max fan speed: ");
    ...
    m_tiStart = new TextInput(this, std::to_string(20), _L("%"), "", wxDefaultPosition, ti_size);
    m_tiStart->GetTextCtrl()->SetValidator(wxTextValidator(wxFILTER_NUMERIC));
    ...
    m_tiEnd = new TextInput(this, std::to_string(100), _L("%"), "", wxDefaultPosition, ti_size);
    m_tiEnd->GetTextCtrl()->SetValidator(wxTextValidator(wxFILTER_NUMERIC));
    ...
    dlg_btns->GetOK()->Bind(wxEVT_BUTTON, &FanSpeed_Test_Dlg::on_start, this);
...
FanSpeed_Test_Dlg::~FanSpeed_Test_Dlg()
{
}

void FanSpeed_Test_Dlg::on_start(wxCommandEvent& event)
{
    bool read_double = false;
    read_double = m_tiStart->GetTextCtrl()->GetValue().ToDouble(&m_params.start);
    read_double = read_double && m_tiEnd->GetTextCtrl()->GetValue().ToDouble(&m_params.end);
    ...
    if (!read_double || m_params.start < 0 || m_params.end > 100 || m_params.step <= 0 || m_params.end < (m_params.start + m_params.step)) {
        MessageDialog msg_dlg(nullptr, _L("Please input valid values:\nmin fan speed >= 0\nmax fan speed <= 100\nstep > 0\nmax fan speed >= min fan speed + step"), wxEmptyString, wxICON_WARNING | wxOK);
        msg_dlg.ShowModal();
        return;
    }

    m_params.mode = CalibMode::Calib_Fan_Speed_Tower;
    m_plater->calib_fan_speed(m_params);
    EndModal(wxID_OK);
}

void FanSpeed_Test_Dlg::on_dpi_changed(const wxRect& suggested_rect)
{
    this->Refresh();
    Fit();
}
...
ScarfJointSpeed_Test_Dlg::ScarfJointSpeed_Test_Dlg(wxWindow* parent, wxWindowID id, Plater* plater)
    : DPIDialog(parent, id, _L("Scarf Joint Speed Test"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE)
    , m_plater(plater)
{
    SetBackgroundColour(*wxWHITE);
    SetForegroundColour(wxColour("#363636"));
    ...
    wxString start_str = _L("Start scarf speed: ");
    wxString end_str   = _L("End scarf speed: ");
    wxString step_str  = _L("Step") + ": ";
    int text_max = GetTextMax(this, std::vector<wxString>{start_str, end_str, step_str});
    ...
    auto info_text = new wxStaticText(this, wxID_ANY,
        _L("Creates a stacked cylindrical scarf seam tower with one section per scarf joint speed. Inspect the seam side and choose the fastest speed that keeps the scarf transition smooth and hidden."),
    ...
    dlg_btns->GetOK()->Bind(wxEVT_BUTTON, &ScarfJointSpeed_Test_Dlg::on_start, this);
...
ScarfJointSpeed_Test_Dlg::~ScarfJointSpeed_Test_Dlg()
{
}

void ScarfJointSpeed_Test_Dlg::on_start(wxCommandEvent& event)
{
    bool read_double = false;
    read_double = m_tiStart->GetTextCtrl()->GetValue().ToDouble(&m_params.start);
    read_double = read_double && m_tiEnd->GetTextCtrl()->GetValue().ToDouble(&m_params.end);
    ...
    if (!read_double || m_params.start <= 0 || m_params.step <= 0 || m_params.end < (m_params.start + m_params.step)) {
        MessageDialog msg_dlg(nullptr, _L("Please input valid values:\nstart scarf speed > 0\nstep > 0\nend scarf speed >= start scarf speed + step"), wxEmptyString, wxICON_WARNING | wxOK);
        msg_dlg.ShowModal();
        return;
    }

    m_params.mode = CalibMode::Calib_Scarf_Joint_Speed;
    m_plater->calib_scarf_joint_speed(m_params);
    EndModal(wxID_OK);
}

void ScarfJointSpeed_Test_Dlg::on_dpi_changed(const wxRect& suggested_rect)
{
    this->Refresh();
    Fit();
}
...
ScarfLengthSteps_Test_Dlg::ScarfLengthSteps_Test_Dlg(wxWindow* parent, wxWindowID id, Plater* plater)
    : DPIDialog(parent, id, _L("Scarf Length / Steps Test"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE)
    , m_plater(plater)
{
    SetBackgroundColour(*wxWHITE);
    SetForegroundColour(wxColour("#363636"));
    ...
    wxString steps_str = _L("Scarf steps: ");
    wxString start_str = _L("Start scarf length: ");
    wxString end_str   = _L("End scarf length: ");
    wxString step_str  = _L("Step") + ": ";
    int text_max = GetTextMax(this, std::vector<wxString>{steps_str, start_str, end_str, step_str});
    ...
    auto steps_sizer = new wxBoxSizer(wxHORIZONTAL);
    auto steps_text = new wxStaticText(this, wxID_ANY, steps_str, wxDefaultPosition, st_size, wxALIGN_LEFT);
    m_tiScarfSteps = new TextInput(this, std::to_string(10), "", "", wxDefaultPosition, ti_size);
    m_tiScarfSteps->GetTextCtrl()->SetValidator(wxTextValidator(wxFILTER_NUMERIC));
    steps_sizer->Add(steps_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    steps_sizer->Add(m_tiScarfSteps, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    settings_sizer->Add(steps_sizer, 0, wxLEFT, FromDIP(3));

    auto start_sizer = new wxBoxSizer(wxHORIZONTAL);
    auto start_text = new wxStaticText(this, wxID_ANY, start_str, wxDefaultPosition, st_size, wxALIGN_LEFT);
    m_tiStart = new TextInput(this, std::to_string(10), _L("mm"), "", wxDefaultPosition, ti_size);
    m_tiStart->GetTextCtrl()->SetValidator(wxTextValidator(wxFILTER_NUMERIC));
    start_sizer->Add(start_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    start_sizer->Add(m_tiStart, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    settings_sizer->Add(start_sizer, 0, wxLEFT, FromDIP(3));
    ...
    auto end_sizer = new wxBoxSizer(wxHORIZONTAL);
    auto end_text = new wxStaticText(this, wxID_ANY, end_str, wxDefaultPosition, st_size, wxALIGN_LEFT);
    m_tiEnd = new TextInput(this, std::to_string(40), _L("mm"), "", wxDefaultPosition, ti_size);
    m_tiEnd->GetTextCtrl()->SetValidator(wxTextValidator(wxFILTER_NUMERIC));
    end_sizer->Add(end_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    end_sizer->Add(m_tiEnd, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    settings_sizer->Add(end_sizer, 0, wxLEFT, FromDIP(3));
    ...
    auto step_sizer = new wxBoxSizer(wxHORIZONTAL);
    auto step_text = new wxStaticText(this, wxID_ANY, step_str, wxDefaultPosition, st_size, wxALIGN_LEFT);
    m_tiStep = new TextInput(this, wxString::FromDouble(5), _L("mm"), "", wxDefaultPosition, ti_size);
    m_tiStep->GetTextCtrl()->SetValidator(wxTextValidator(wxFILTER_NUMERIC));
    step_sizer->Add(step_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    step_sizer->Add(m_tiStep, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    settings_sizer->Add(step_sizer, 0, wxLEFT, FromDIP(3));
    ...
    auto info_text = new wxStaticText(this, wxID_ANY,
        _L("Creates a stacked cylindrical scarf seam tower with one section per scarf length. Scarf steps are held constant so length is the only swept variable."),
        wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
    info_text->Wrap(FromDIP(390));
    settings_sizer->Add(info_text, 0, wxALL | wxEXPAND, FromDIP(5));
    ...
    dlg_btns->GetOK()->Bind(wxEVT_BUTTON, &ScarfLengthSteps_Test_Dlg::on_start, this);
...
ScarfLengthSteps_Test_Dlg::~ScarfLengthSteps_Test_Dlg()
{
}

void ScarfLengthSteps_Test_Dlg::on_start(wxCommandEvent& event)
{
    long scarf_steps = 0;
    bool read_double = false;
    read_double = m_tiStart->GetTextCtrl()->GetValue().ToDouble(&m_params.start);
    read_double = read_double && m_tiEnd->GetTextCtrl()->GetValue().ToDouble(&m_params.end);
    read_double = read_double && m_tiStep->GetTextCtrl()->GetValue().ToDouble(&m_params.step);
    bool read_steps = m_tiScarfSteps->GetTextCtrl()->GetValue().ToLong(&scarf_steps);

    if (!read_double || !read_steps || scarf_steps < 1 || m_params.start > 0 && m_params.start < 1 || m_params.step <= 0 || m_params.end < (m_params.start + m_params.step)) {
        MessageDialog msg_dlg(nullptr, _L("Please input valid values:\nscarf steps >= 1\nstart scarf length = 0 or >= 1 mm\nstep > 0\nend scarf length >= start scarf length + step"), wxEmptyString, wxICON_WARNING | wxOK);
        msg_dlg.ShowModal();
        return;
    }

    m_params.scarf_steps = static_cast<int>(scarf_steps);
    m_params.mode = CalibMode::Calib_Scarf_Length_Steps;
    m_plater->calib_scarf_length_steps(m_params);
    EndModal(wxID_OK);
}

void ScarfLengthSteps_Test_Dlg::on_dpi_changed(const wxRect& suggested_rect)
{
    this->Refresh();
    Fit();
}
...
BridgeSpeed_Test_Dlg::BridgeSpeed_Test_Dlg(wxWindow* parent, wxWindowID id, Plater* plater)
    : DPIDialog(parent, id, _L("Bridge speed test"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE)
    , m_plater(plater)
{
    SetBackgroundColour(*wxWHITE);
    SetForegroundColour(wxColour("#363636"));
    ...
    wxString start_str = _L("Start bridge speed: ");
    wxString end_str   = _L("End bridge speed: ");
    wxString step_str  = _L("Step") + ": ";
    int text_max = GetTextMax(this, std::vector<wxString>{start_str, end_str, step_str});
    ...
    auto end_sizer = new wxBoxSizer(wxHORIZONTAL);
    auto end_text = new wxStaticText(this, wxID_ANY, end_str, wxDefaultPosition, st_size, wxALIGN_LEFT);
    m_tiEnd = new TextInput(this, std::to_string(35), _L("mm/s"), "", wxDefaultPosition, ti_size);
    m_tiEnd->GetTextCtrl()->SetValidator(wxTextValidator(wxFILTER_NUMERIC));
    end_sizer->Add(end_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    end_sizer->Add(m_tiEnd, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    settings_sizer->Add(end_sizer, 0, wxLEFT, FromDIP(3));
    ...
    auto info_text = new wxStaticText(this, wxID_ANY,
        _L("Creates one plate with bridge coupons for 10, 20, and 30 mm spans at each tested speed."),
        wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
    ...
    dlg_btns->GetOK()->Bind(wxEVT_BUTTON, &BridgeSpeed_Test_Dlg::on_start, this);
...
BridgeSpeed_Test_Dlg::~BridgeSpeed_Test_Dlg()
{
}

void BridgeSpeed_Test_Dlg::on_start(wxCommandEvent& event)
{
    bool read_double = false;
    read_double = m_tiStart->GetTextCtrl()->GetValue().ToDouble(&m_params.start);
    read_double = read_double && m_tiEnd->GetTextCtrl()->GetValue().ToDouble(&m_params.end);
    ...
    if (!read_double || m_params.start <= 0 || m_params.step <= 0 || m_params.end < (m_params.start + m_params.step)) {
        MessageDialog msg_dlg(nullptr, _L("Please input valid values:\nstart bridge speed > 0\nstep > 0\nend bridge speed >= start bridge speed + step"), wxEmptyString, wxICON_WARNING | wxOK);
        msg_dlg.ShowModal();
        return;
    }

    m_params.mode = CalibMode::Calib_Bridge_Speed;
    m_plater->calib_bridge_speed(m_params);
    EndModal(wxID_OK);
}

void BridgeSpeed_Test_Dlg::on_dpi_changed(const wxRect& suggested_rect)
{
    this->Refresh();
    Fit();
}
...
BridgeFlow_Test_Dlg::BridgeFlow_Test_Dlg(wxWindow* parent, wxWindowID id, Plater* plater)
    : DPIDialog(parent, id, _L("Bridge flow test"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE)
    , m_plater(plater)
{
    SetBackgroundColour(*wxWHITE);
    SetForegroundColour(wxColour("#363636"));
    ...
    wxString step_str         = _L("Step") + ": ";
    int text_max = GetTextMax(this, std::vector<wxString>{bridge_speed_str, start_str, end_str, step_str});
    ...
    auto start_sizer = new wxBoxSizer(wxHORIZONTAL);
    auto start_text = new wxStaticText(this, wxID_ANY, start_str, wxDefaultPosition, st_size, wxALIGN_LEFT);
    m_tiStart = new TextInput(this, wxString::FromDouble(0.8), "", "", wxDefaultPosition, ti_size);
    m_tiStart->GetTextCtrl()->SetValidator(wxTextValidator(wxFILTER_NUMERIC));
    start_sizer->Add(start_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    start_sizer->Add(m_tiStart, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    settings_sizer->Add(start_sizer, 0, wxLEFT, FromDIP(3));
    ...
    auto end_sizer = new wxBoxSizer(wxHORIZONTAL);
    auto end_text = new wxStaticText(this, wxID_ANY, end_str, wxDefaultPosition, st_size, wxALIGN_LEFT);
    m_tiEnd = new TextInput(this, wxString::FromDouble(1.1), "", "", wxDefaultPosition, ti_size);
    m_tiEnd->GetTextCtrl()->SetValidator(wxTextValidator(wxFILTER_NUMERIC));
    end_sizer->Add(end_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    end_sizer->Add(m_tiEnd, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    settings_sizer->Add(end_sizer, 0, wxLEFT, FromDIP(3));
    ...
    auto step_sizer = new wxBoxSizer(wxHORIZONTAL);
    auto step_text = new wxStaticText(this, wxID_ANY, step_str, wxDefaultPosition, st_size, wxALIGN_LEFT);
    m_tiStep = new TextInput(this, wxString::FromDouble(0.05), "", "", wxDefaultPosition, ti_size);
    m_tiStep->GetTextCtrl()->SetValidator(wxTextValidator(wxFILTER_NUMERIC));
    step_sizer->Add(step_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    step_sizer->Add(m_tiStep, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    settings_sizer->Add(step_sizer, 0, wxLEFT, FromDIP(3));
    ...
    auto info_text = new wxStaticText(this, wxID_ANY,
        _L("Creates one plate with bridge coupons at the fixed bridge speed, sweeping bridge flow ratio."),
        wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
    info_text->Wrap(FromDIP(360));
    settings_sizer->Add(info_text, 0, wxALL | wxEXPAND, FromDIP(5));
    ...
    dlg_btns->GetOK()->Bind(wxEVT_BUTTON, &BridgeFlow_Test_Dlg::on_start, this);
...
BridgeFlow_Test_Dlg::~BridgeFlow_Test_Dlg()
{
}

void BridgeFlow_Test_Dlg::on_start(wxCommandEvent& event)
{
    bool read_double = false;
    ...
    if (!read_double || m_params.bridge_speed <= 0 || m_params.start <= 0 || m_params.step <= 0 || m_params.end < (m_params.start + m_params.step)) {
        MessageDialog msg_dlg(nullptr, _L("Please input valid values:\nbridge speed > 0\nstart bridge flow > 0\nstep > 0\nend bridge flow >= start bridge flow + step"), wxEmptyString, wxICON_WARNING | wxOK);
        msg_dlg.ShowModal();
        return;
    }

    m_params.mode = CalibMode::Calib_Bridge_Flow;
    m_plater->calib_bridge_flow(m_params);
    EndModal(wxID_OK);
}

void BridgeFlow_Test_Dlg::on_dpi_changed(const wxRect& suggested_rect)
{
    this->Refresh();
    Fit();
}
...
BridgeDensity_Test_Dlg::BridgeDensity_Test_Dlg(wxWindow* parent, wxWindowID id, Plater* plater)
    : DPIDialog(parent, id, _L("Bridge density test"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE)
    , m_plater(plater)
{
    SetBackgroundColour(*wxWHITE);
    SetForegroundColour(wxColour("#363636"));
    ...
    wxString start_str        = _L("Start bridge density: ");
    wxString end_str          = _L("End bridge density: ");
    wxString step_str         = _L("Step") + ": ";
    int text_max = GetTextMax(this, std::vector<wxString>{bridge_speed_str, bridge_flow_str, start_str, end_str, step_str});
    ...
    auto start_sizer = new wxBoxSizer(wxHORIZONTAL);
    auto start_text = new wxStaticText(this, wxID_ANY, start_str, wxDefaultPosition, st_size, wxALIGN_LEFT);
    m_tiStart = new TextInput(this, wxString::FromDouble(80), _L("%"), "", wxDefaultPosition, ti_size);
    m_tiStart->GetTextCtrl()->SetValidator(wxTextValidator(wxFILTER_NUMERIC));
    start_sizer->Add(start_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    start_sizer->Add(m_tiStart, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    settings_sizer->Add(start_sizer, 0, wxLEFT, FromDIP(3));
    ...
    auto end_sizer = new wxBoxSizer(wxHORIZONTAL);
    auto end_text = new wxStaticText(this, wxID_ANY, end_str, wxDefaultPosition, st_size, wxALIGN_LEFT);
    m_tiEnd = new TextInput(this, wxString::FromDouble(125), _L("%"), "", wxDefaultPosition, ti_size);
    m_tiEnd->GetTextCtrl()->SetValidator(wxTextValidator(wxFILTER_NUMERIC));
    end_sizer->Add(end_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    end_sizer->Add(m_tiEnd, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(2));
    settings_sizer->Add(end_sizer, 0, wxLEFT, FromDIP(3));
    ...
    auto info_text = new wxStaticText(this, wxID_ANY,
        _L("Creates one plate with bridge coupons at the fixed bridge speed and flow, sweeping bridge density."),
        wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
    info_text->Wrap(FromDIP(360));
    settings_sizer->Add(info_text, 0, wxALL | wxEXPAND, FromDIP(5));
    ...
    dlg_btns->GetOK()->Bind(wxEVT_BUTTON, &BridgeDensity_Test_Dlg::on_start, this);
...
BridgeDensity_Test_Dlg::~BridgeDensity_Test_Dlg()
{
}

void BridgeDensity_Test_Dlg::on_start(wxCommandEvent& event)
{
    bool read_double = false;
    read_double = m_tiBridgeSpeed->GetTextCtrl()->GetValue().ToDouble(&m_params.bridge_speed);
    ...
    if (!read_double || m_params.bridge_speed <= 0 || m_params.bridge_flow <= 0 || m_params.start < 10 || m_params.end > 125 || m_params.step <= 0 || m_params.end < (m_params.start + m_params.step)) {
        MessageDialog msg_dlg(nullptr, _L("Please input valid values:\nbridge speed > 0\nbridge flow > 0\n10 <= bridge density <= 125\nstep > 0\nend bridge density >= start bridge density + step"), wxEmptyString, wxICON_WARNING | wxOK);
        msg_dlg.ShowModal();
        return;
    }

    m_params.mode = CalibMode::Calib_Bridge_Density;
    m_plater->calib_bridge_density(m_params);
    EndModal(wxID_OK);
}

void BridgeDensity_Test_Dlg::on_dpi_changed(const wxRect& suggested_rect)
{
    this->Refresh();
    Fit();
}
